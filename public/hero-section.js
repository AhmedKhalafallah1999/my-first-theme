...
"use strict";
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/.pnpm/@babel+runtime@7.28.4/node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/.pnpm/@babel+runtime@7.28.4/node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);\n\n\ndocument.addEventListener(\"DOMContentLoaded\", /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {\n  var heroWrap, res, block, title, desc, btn, _t;\n  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context) {\n    while (1) switch (_context.prev = _context.next) {\n      case 0:\n        heroWrap = typeof app !== \"undefined\" && typeof app.element === \"function\" ? app.element(\"#hero-section\") : document.querySelector(\"#hero-section\");\n        if (heroWrap) {\n          _context.next = 1;\n          break;\n        }\n        console.error(\"Hero Section wrapper (#hero-section) not found in DOM!\");\n        return _context.abrupt(\"return\");\n      case 1:\n        _context.prev = 1;\n        _context.next = 2;\n        return salla.api.request(\"component/list\", {\n          params: {\n            paths: [\"home.hero-section\"]\n          }\n        });\n      case 2:\n        res = _context.sent;\n        console.log(\"Hero Section API response:\", res);\n        block = res.data && res.data[0] && res.data[0].component ? res.data[0].component : null;\n        if (block) {\n          _context.next = 3;\n          break;\n        }\n        console.warn(\"Hero Section component is not configured in Theme Dashboard.\");\n        heroWrap.innerHTML = '<p style=\"color:red; text-align:center;\">Hero Section component is missing!</p>';\n        return _context.abrupt(\"return\");\n      case 3:\n        title = block.title || \"مرحبًا بك في متجرنا\";\n        desc = block.desc || \"أفضل المنتجات مع أفضل العروض\";\n        btn = block.btn || \"تسوق الآن\";\n        heroWrap.innerHTML = '<section class=\"hero-section container\" style=\"' + \"background: linear-gradient(135deg, #ff7e5f, #feb47b);\" + \"color: #fff;\" + \"padding: 100px 0;\" + \"text-align: center;\" + \"border-radius: 20px;\" + \"overflow: hidden;\" + '\">' + '<div class=\"hero-item\">' + '<h1 style=\"font-size: 3rem; font-weight: bold; margin-bottom: 20px;\">' + title + \"</h1>\" + '<p style=\"font-size: 1.5rem; margin-bottom: 30px;\">' + desc + \"</p>\" + '<a href=\"#!\" style=\"display: inline-block; padding: 15px 40px; background-color: #fff; color: #ff7e5f; font-weight: bold; text-decoration: none; border-radius: 50px; transition: 0.3s;\">' + btn + \"</a>\" + \"</div>\" + \"</section>\";\n        _context.next = 5;\n        break;\n      case 4:\n        _context.prev = 4;\n        _t = _context[\"catch\"](1);\n        console.error(\"Hero Section load error:\", _t);\n        heroWrap.innerHTML = '<p style=\"color:red; text-align:center;\">Error loading Hero Section</p>';\n      case 5:\n      case \"end\":\n        return _context.stop();\n    }\n  }, _callee, null, [[1, 4]]);\n})));\nadocument.addEventListener(\"DOMContentLoaded\", /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee2() {\n  var heroWrap, _res$data, res, block, title, desc, btn, _t2;\n  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function (_context2) {\n    while (1) switch (_context2.prev = _context2.next) {\n      case 0:\n        if (typeof app !== \"undefined\" && app.element && typeof app.element === \"function\") {\n          heroWrap = app.element(\"#hero-section\");\n        } else {\n          heroWrap = document.querySelector(\"#hero-section\");\n        }\n        if (heroWrap) {\n          _context2.next = 1;\n          break;\n        }\n        console.error(\"Hero Section wrapper (#hero-section) not found in DOM!\");\n        return _context2.abrupt(\"return\");\n      case 1:\n        _context2.prev = 1;\n        _context2.next = 2;\n        return salla.api.request(\"component/list\", {\n          params: {\n            paths: [\"home.hero-section\"]\n          }\n        });\n      case 2:\n        res = _context2.sent;\n        block = ((_res$data = res.data) === null || _res$data === void 0 || (_res$data = _res$data[0]) === null || _res$data === void 0 ? void 0 : _res$data.component) || null;\n        if (block) {\n          _context2.next = 3;\n          break;\n        }\n        console.warn(\"Hero Section component is not configured in Theme Dashboard.\");\n        heroWrap.innerHTML = '<p style=\"color:red; text-align:center;\">Hero Section component is missing!</p>';\n        return _context2.abrupt(\"return\");\n      case 3:\n        title = block.title || \"مرحبًا بك في متجرنا\";\n        desc = block.desc || \"أفضل المنتجات مع أفضل العروض\";\n        btn = block.btn || \"تسوق الآن\";\n        heroWrap.innerHTML = \"\\n      <section class=\\\"hero-section container\\\" style=\\\"\\n          background: linear-gradient(135deg, #ff7e5f, #feb47b);\\n          color: #fff;\\n          padding: 100px 0;\\n          text-align: center;\\n          border-radius: 20px;\\n          overflow: hidden;\\n      \\\">\\n        <div class=\\\"hero-item\\\">\\n          <h1 style=\\\"font-size: 3rem; font-weight: bold; margin-bottom: 20px;\\\">\".concat(title, \"</h1>\\n          <p style=\\\"font-size: 1.5rem; margin-bottom: 30px;\\\">\").concat(desc, \"</p>\\n          <a href=\\\"#!\\\" style=\\\"\\n              display: inline-block;\\n              padding: 15px 40px;\\n              background-color: #fff;\\n              color: #ff7e5f;\\n              font-weight: bold;\\n              text-decoration: none;\\n              border-radius: 50px;\\n              transition: 0.3s;\\n          \\\">\").concat(btn, \"</a>\\n        </div>\\n      </section>\\n    \");\n        _context2.next = 5;\n        break;\n      case 4:\n        _context2.prev = 4;\n        _t2 = _context2[\"catch\"](1);\n        console.error(\"Hero Section load error:\", _t2);\n        heroWrap.innerHTML = '<p style=\"color:red; text-align:center;\">Error loading Hero Section</p>';\n      case 5:\n      case \"end\":\n        return _context2.stop();\n    }\n  }, _callee2, null, [[1, 4]]);\n})));\n\n//# sourceURL=webpack://theme-raed/./src/assets/js/components/hero-section.js?\n}");
